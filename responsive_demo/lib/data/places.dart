...
final allPlaces = <Place>[
  Place(
    ...
    title: 'Leh',
    subtitle: 'White paradise in ladakh',
    description:
        'Prepare to be wooed by the mesmerizing mountains of Leh. You will love sightseeing and the surreal vistas of snow-capped mountains. Leh is also known for its unique wildlife.',
  ),
  Place(
    image: 'images/gokarna.jpg',
    title: 'Gokarna',
    subtitle: 'Scenic temple town in karnataka',
    description:
        'Prepare to be wooed by the mesmerizing mountains of Leh. You will love sightseeing and the surreal vistas of snow-capped mountains. Leh is also known for its unique wildlife.',
  ),
  Place(
    ...
    title: 'Srinagar',
    subtitle: 'Paradise on the Banks of Jhelum',
    description:
        'A dreamy honeymoon awaits you at Srinagar. You will love sightseeing and the lively festivals. Don’t forget to sample the delicious cuisines at Srinagar.',
  ),
  Place(
    image: 'images/havlock-island.jpg',
    title: 'Havlock Island',
    subtitle: 'Picturesque Tropical Getaway in the Andamans',
    description:
  ...
  Place(
    ...
    title: 'Puducherry',
    subtitle: 'Bewitching French City',
    description:
  ...
  Place(
    ...
    title: 'Manali',
    subtitle: 'Say hello to hippie villages and scenic valleys. ',
    description:
  ...
  Place(
    ...
    title: 'Alleppey',
    subtitle: 'Nature Lover’s Paradise in Kerala',
    description:
  ...
  Place(
    ...
    title: 'Amritsar',
    subtitle: 'The Spiritual Capital of Punjab',
    description:
        'Soak in the mystic hues of Amritsar, a famous pilgrimage spot! You will love exploring sightseeing attractions and attending various festivals. The local cuisines at Amritsar are worth trying out too.',
  ),
  Place(
    image: 'images/coorg.jpg',
    title: 'Coorg',
    subtitle: 'Scenic Hill Station in Karnataka',
    description:
